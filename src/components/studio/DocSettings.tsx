          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-white/8 px-5 py-4">
              <div>
                ...
                <div className="text-xs text-foreground/40">What your agents read · how your brand looks</div>
              </div>
            ...
            <div className="flex shrink-0 items-center gap-1 border-b border-white/8 px-3 py-2">
              {([["knowledge", "Knowledge", FileText], ["branding", "Branding", Palette]] as const).map(([key, label, Icon]) => (
                <button
                  key={key}
                  onClick={() => setTab(key)}
                  className={cn(
            ...
            {tab === "knowledge" ? <KnowledgePanel open={open} /> : <BrandingPanel open={open} />}
          </motion.div>
        </>
      )}
    </AnimatePresence>
