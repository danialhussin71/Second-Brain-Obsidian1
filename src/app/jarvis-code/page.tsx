...
import { ChartLineUp, ArrowSquareOut, Brain, GearSix, SpeakerHigh, SpeakerSlash, Terminal, Coins, ArrowsClockwise } from "@phosphor-icons/react";
...
/** The badge that marks this cockpit as Claude-Code-powered. */
function ClaudeCodeTag() {
  return (
    <span className="flex items-center gap-1.5 rounded-full border border-amber-300/30 bg-amber-400/[0.08] px-2.5 py-1 text-[9.5px] font-bold uppercase tracking-[0.18em] text-amber-200/90">
...
function MetaStrip({
  ...
  return (
    <div className="mx-auto flex h-[18px] items-center gap-3 text-[10.5px] font-medium tracking-wide text-white/40">
      ...
      {running && <span className="text-amber-200/70">· working on your subscription…</span>}
    </div>
  );
}
